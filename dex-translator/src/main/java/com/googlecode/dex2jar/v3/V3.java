...
public class V3 implements DexFileVisitor {
    ...
    protected ClassVisitorFactory classVisitorFactory;
    ...
    public DexClassVisitor visit(int access_flags, String className, String superClass, String[] interfaceNames) {
        final ClassVisitor classVisitor = classVisitorFactory.create(Type.getType(className).getInternalName());
        if (classVisitor == null) {
            return null;
        }
        return new V3ClassAdapter(innerClz.get(className), this.exceptionHandler, classVisitor, access_flags, className,
